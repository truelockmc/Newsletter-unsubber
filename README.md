...
1. **Storing Email Credentials**: On the first launch, you enter your email address, password, and name. These credentials are secure stored on your device using keyrings.
